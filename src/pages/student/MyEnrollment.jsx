...
const MyEnrollment = () => {
  ...
  useEffect(() => {
    // Ideally, this data should come from your backend or context
    setProgressArray([
          ...
          <table className="w-full border-collapse bg-white shadow-lg rounded-lg">
            ...
            <tbody className="text-gray-700 text-xs sm:text-sm">
              {enrolledCourses.map((course, index) => {
                // SAFETY FIX: Prevent crash if progressArray is missing data for this index
                    ...
                    <td className="px-4 py-3 flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <Line
                          ...
                          strokeWidth={2} // Make the line visible
                          strokeColor="#3B82F6" // Blue color
                          trailWidth={2}
                          trailColor="#D1D5DB" // Grey background
